...
echo "Labels: $Labels"
echo "Include_Exclude: $Include_Exclude"
...
# Run SPAC template
python -c "from spac.templates.subset_analysis_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
